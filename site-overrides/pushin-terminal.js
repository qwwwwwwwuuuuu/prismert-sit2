(function () {
  ...
  function header(active) {
    ...
    var nav = [
      ...
      ["protocol", "/protocol.html", "Protocol"], ["docs", "/docs.html", "Docs"], ["tokenomics", "/tokenomics.html", "Tokenomics"], ["roadmap", "/roadmap.html", "Roadmap"]
    ];
  ...
  function shell(active, content) {
    return '<div class="pa-shell">' + header(active) + ticker() + '<main class="pa-main">' + content + '</main>' + statusbar() + '</div>';
  }
