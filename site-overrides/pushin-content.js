(function () {
  ...
  function start() {
    ...
    if (body.classList.contains('pusheen-branded-page') && !body.classList.contains('pusheen-page--home') && !body.classList.contains('pusheen-workspace-page')) {
      let scene = /pusheen-page--(docs|roadmap|tokenomics)/.test(body.className) ? 'docs-clean-v4.webp' : /pusheen-page--(connect|portfolio)/.test(body.className) ? 'settlement-clean-v2.webp' : 'analysis-cutout.png';
