...
function patchHtml(dir) {
  for (const entry of readdirSync(dir, {withFileTypes:true})) {
    ...
    html=html.replace(/<script src="\/(?:pushin-paper-app-v1|pushin-mainnet-app|pushin-mainnet-wallet|pushin-simulator|pushin-terminal)\.js" defer><\/script>/g,'');
    html=html.replace(/<link rel="stylesheet" href="\/(?:pushin-paper-app-v1|pushin-mainnet|pushin-terminal)\.css"\s*\/?>/g,'');
    html=html.replace('</head>','<link rel="stylesheet" href="/pushin-terminal.css"/><link rel="stylesheet" href="/pushin-mainnet.css"/><script src="/pushin-mainnet-wallet.js" defer></script><script src="/pushin-mainnet-app.js" defer></script><script src="/pushin-terminal.js" defer></script></head>');
